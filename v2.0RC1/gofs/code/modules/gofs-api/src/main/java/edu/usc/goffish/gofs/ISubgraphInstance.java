...
/**
 * This represents a single instance of data associated with a subgraph. It has methods to retrieve information about
 * the instance as well as to query properties for a specific vertex or edge.
 */
public interface ISubgraphInstance {
	...
	/**
	 * Returns true if there is any vertex or edge property data associated with this instance, false otherwise.
	 * 
	 * @return true if there is any vertex or edge property data associated with this instance, false otherwise
	 */
