...
Jython script to write/read graph partition and instances. It also does BFS traversal and prints all the vertex attribute values, and also computes the total edge weight.
