...
/**
 * This class represents a single property that an instance might contain values
 * for. A property may be either static or dynamic. If the property is static,
 * it will have a single given value on a per vertex/edge basis, and no per
 * instance values may be specified to override this. If the property is dynamic
 * it may have defaults specified on a per vertex/edge basis, but instance
 * values will override these defaults.
 */
public final class Property {
	...
	public Property(String name, Class<? extends Object> type, boolean isStatic, Map<Long, Object> defaultValues) {
		...
		// TODO: this is a pretty expensive check for a single instance
		...
		// TODO: can we avoid defensive copy?
	 ...
	 * 
	 * @return true if this is a static property, false if this is a dynamic
	 *         property
	 */
