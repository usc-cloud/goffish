...
public class TemplateGraph extends AbstractGraph<TemplateVertex, TemplateEdge> implements IMutableGraph<TemplateVertex, TemplateEdge>, ISubgraphTemplate {
	...
	public TemplateGraph(boolean directed, int initialCapacity) {
		_directed = directed;
		_vertexMap = new Long2ObjectOpenHashMap<>(initialCapacity, 1f);
	}
	...
	public Iterable<TemplateVertex> vertices() {
		return new ReadOnlyIterable<>(_vertexMap.values());
	}
