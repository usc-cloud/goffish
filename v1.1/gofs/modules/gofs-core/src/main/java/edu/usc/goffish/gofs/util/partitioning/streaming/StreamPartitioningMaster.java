...
public final class StreamPartitioningMaster {
	...
	private final class StreamPartition implements IStreamPartition {
		...
		public boolean containsVertex(IIdentifiableVertex vertex) {
			...
			return partitionId != null && partitionId.intValue() == _partitionId;
		}

		@Override
		public int size() {
			return _partitionSizes[_partitionId].get();
		}
		...
		public void addVertex(IIdentifiableVertex vertex) {
			...
			_vertexPartitions.put(vertex.getId(), _partitionId);
			_partitionSizes[_partitionId].incrementAndGet();
		}
		
		@Override
		public String toString() {
			return "StreamPartition@" + _partitionId + "[size=" +  _partitionSizes[_partitionId].get() + "]";
		}
	}
}
