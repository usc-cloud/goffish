...
public class Client {
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        if(args.length != 5) {
            throw new RuntimeException("args[0]=Host to connect  ,  arg[1]=data port arg[2]=control port , arg[3]=licenceID,arg[4]=lastknown time in mills");
        }
        ...
        msg.setSuperStep(0);
        msg.setType(BSPMessage.DATA);
        String subData = "NILL,"+args[4]+"," + args[3];
       // String subData = "NILL,1371141413559,2323abc";
        SubGraphMessage subMsg = new SubGraphMessage(subData.getBytes());
        msg.setData(BitConverter.getBytes(subMsg));
        ...
        tempMessage =  MessageFactory.createDefaultMessage();
        msg = new BSPMessage();
        msg.setSuperStep(0);
        msg.setType(BSPMessage.CTRL);

        payLoad = BitConverter.getBytes(msg);
