            ...
            try {
                ...
                if (o instanceof BSPMessage) {
                    ...
                    if (message.getType() == BSPMessage.INIT) {
                        ...
                        StatLogger.getInstance().log("PARTITION_TOTAL," + partition.getId() + "," +
                                (System.currentTimeMillis() - partitionStart));
                        ...
                        for(ISubgraph subgraph : subGraphMap.values()) {
                            ...
                            StatLogger.getInstance().log("TOTAL_SLICES," + partition.getId() + "," +
                                    + subgraph.getId() + "," + numSlices + "," +
                                    System.currentTimeMillis());
                    ...
                    if (message.getType() == BSPMessage.CTRL) {
                        ...
                        StatLogger.getInstance().log("SUPER_STEP_COMPUTE," + partition.getId() + "," +
                                partition.getId() +"," + (System.currentTimeMillis() - superSComputeS) + "," +
