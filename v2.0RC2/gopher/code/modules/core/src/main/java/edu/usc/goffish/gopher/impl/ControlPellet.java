            ...
            try {
                ...
                if (o instanceof BSPMessage) {
                    ...
                    if (superStep == currentSuperStep) {
                            ...
                            if (++haltVotes == numberOfProcessors) {
                                ...
                                if (!isIterative) {
                                    ...
                                    if (currentIteration < (numberOfIterations - 1)) {
                                        ...
                                        currentIteration++;
                                        currentSuperStep = -1; // TODO:YS: Should this be '0'?
                                        //CW : NO we should set this to -1. It will be incremented to 0 before sending.
                                        //TODO:YS: Should we be emitting a control message here to start the next iteration? Should we have a continue?
                                        //CW: this is not a bug. This we send this message this step just reset the super step value
                                    } else {
                      ...
                      //TODO:YS: Why don't you just use haltVotes instead of syncMessageCount? Why two variables?
                      //CW: Not a bug , syncMessageCount and haltVotes serves  two different purposes.
