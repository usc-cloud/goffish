...
namespace boost {
  ...
  struct max_priority_queue_t { };
	//Alok Added for chong_extract_high_betweenness
	struct betweenness_extract_count_t { };
	struct betweenness_batch_size_t { };
	struct betweenness_max_stable_count_t { };
...
#define BOOST_BGL_DECLARE_NAMED_PARAMS \
    ...
    BOOST_BGL_ONE_PARAM_REF(betweenness_extract_count, betweenness_extract_count) \
    BOOST_BGL_ONE_PARAM_REF(betweenness_batch_size, betweenness_batch_size) \
    BOOST_BGL_ONE_PARAM_REF(betweenness_max_stable_count, betweenness_max_stable_count)
