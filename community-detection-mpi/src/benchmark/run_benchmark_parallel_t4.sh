...
#####################################################################
#
# File       : run_benchmark_parallel_t4.sh
#
# Description: Generates benchmarking results for report for TC=4
#
#
...
RFILE_PARALLEL=benchmark_parallel_t${TC}.txt

# STDOUT files
STDOUT_PARALLEL=benchmark_parallel_stdout_t${TC}.txt
